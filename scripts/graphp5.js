...
let graphSketch = (p) => {
  ...
  p.reset = () => {
    ...
    prev_x = 0;
    prev_y = { SUSCEPTIBLE: sirsim.getNumberOfBalls(), INFECTIOUS: 0, RECOVERED: 0,
      VACCINATED: sirsim.getNumberVaccinated(), QUARANTINED: 0}; // PREV was: SUSCEPTIBLE: 0
  ...
  function createLineDrawer(numberOfBalls) {
    ...
    let prev_x = 0, prev_y = { SUSCEPTIBLE: sirsim.getNumberOfBalls() - sirsim.getNumberVaccinated(),
      INFECTIOUS: 0, RECOVERED: 0, VACCINATED: sirsim.getNumberVaccinated(), QUARANTINED: 0 }; // PREV was: SUSCEPTIBLE: 0
